...
const MinimalLandingPage = () => {
  ...
  const handleOpenPresale = () => {
    console.log('Opening presale modal...');
    setIsPresaleModalOpen(true);
  };

  const handleClosePresale = () => {
    console.log('Closing presale modal...');
    ...
    <>
      <div className="relative bg-gray-900">
        ...
        <footer className="bg-gray-900 py-8 text-center">
          <p className="text-gray-400">© 2025 Viazen. Todos los derechos reservados.</p>
          <p className="text-blue-400 mt-2">"Libertad, recompensa y expansión global."</p>
        </footer>
      </div>
